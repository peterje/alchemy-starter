...
/** Builds the store for one kind of versioned file. JSON columns decode through the file's schemas. */
export const make = <Meta, Item extends { readonly id: string }>(file: {
